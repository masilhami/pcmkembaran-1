  ...
  return (
    <main className="post-detail-main">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .dl-button-modern { background: var(--abah-blue); color: #fff; padding: 16px 32px; border-radius: 16px; font-weight: 900; font-size: 12px; text-decoration: none; transition: 0.3s; white-space: nowrap; box-shadow: 0 10px 20px rgba(0,74,142,0.15); }
